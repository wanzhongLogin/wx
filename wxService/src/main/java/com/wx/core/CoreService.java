...
import com.wx.base.common.Error;
...
public class CoreService {
    ...
    private String handRequest(Map<String, String> requestMap) {
        ...
        AssertUtils.notBlank(msgType, Error.msg_type_is_null.getMessage());

        //获取对应的消息类型的处理策略
        HandStrategy bean = applicationUtil.getBean(msgType, HandStrategy.class);
        AssertUtils.notNull(bean,Error.msg_type_can_found_strategy.getMessage());
